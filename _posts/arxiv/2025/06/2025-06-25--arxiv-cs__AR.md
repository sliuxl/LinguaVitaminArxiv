---
title: "cs.AR @ 2025-06-25: 046"
date: 2025-06-25
layout: post
---

- [00](#article-0) | **06-24 (2)** | Robotics Under Construction: Challenges on Job Sites | Robotik im Bau: Herausforderungen auf Job-Sites | 正在建设中的机器人:工作场所的挑战 | [2506.19597v1](http://arxiv.org/abs/2506.19597v1)
- [01](#article-1) | 06-24 | Mixture of Cache-Conditional Experts for Efficient Mobile Device   Inference | Mischung aus Cache-Conditional Experts für effiziente mobile Geräteableitung | 高效移动设备引力缓存-条件专家混合 | [2412.00099v2](http://arxiv.org/abs/2412.00099v2)
- [02](#article-2) | 06-24 | ChatModel: Automating Reference Model Design and Verification with LLMs | ChatModel: Automatisieren von Referenzmodell-Design und Überprüfung mit LLMs | 聊天模式:使用LLMs自动使用参考模型设计和核查 | [2506.15066v2](http://arxiv.org/abs/2506.15066v2)
- [03](#article-3) | 06-24 | In-Memory Sorting-Searching with Cayley Tree | In-Memory-Sortierung-Suche mit Cayley-Baum | 与 Cayley 树一起在记忆中排序- 使用 Cayley 树 | [2506.19379v1](http://arxiv.org/abs/2506.19379v1)
- [04](#article-4) | 06-24 | Efficient Hardware Implementation of Modular Multiplier over GF (2m) on   FPGA | Effiziente Hardware-Implementierung des Modularen Multiplikators über GF (2m) auf FPGA | 在FPGA上实施超过2米的GF(2GF)的模块倍增器的高效硬件 | [2506.09464v3](http://arxiv.org/abs/2506.09464v3)
- [05](#article-5) | **06-23 (1)** | MEDEA: A Design-Time Multi-Objective Manager for Energy-Efficient DNN   Inference on Heterogeneous Ultra-Low Power Platforms | MEDEA: Design-Time Multi-Objective Manager für energieeffiziente DNN-Inferenz auf heterogenen Ultra-Low-Power-Plattformen | MEDEA: 能源效率DNN热能超低层动力平台的热源性DN推论设计-时间多目标管理员 | [2506.19067v1](http://arxiv.org/abs/2506.19067v1)
- [06](#article-6) | 06-23 | Design high-confidence computers using trusted instructional set   architecture and emulators | Design von Computern mit hohem Vertrauen mit vertrauenswürdigen Lehrset-Architektur und Emulatoren | 使用可信赖的教学系统架构和模拟器设计高自信计算机 | [2506.18780v1](http://arxiv.org/abs/2506.18780v1)
- [07](#article-7) | 06-23 | EasyDRAM: An FPGA-based Infrastructure for Fast and Accurate End-to-End   Evaluation of Emerging DRAM Techniques | EasyDRAM: Eine FPGA-basierte Infrastruktur für eine schnelle und präzise End-to-End-Bewertung neu entstehender DRAM-Techniken | AFACDRAM: 以FPGA为基础的快速和准确端至端评价新兴DRAM技术基础设施 | [2506.10441v2](http://arxiv.org/abs/2506.10441v2)
- [08](#article-8) | 06-23 | Embedded FPGA Acceleration of Brain-Like Neural Networks: Online   Learning to Scalable Inference | Embedded FPGA Beschleunigung von Gehirn-ähnlichen Neuronalen Netzwerken: Online-Lernen zu skalierbarer Inferenz | FPGA 脑如神经网络加速FPGA嵌入式FPGA:在线学习可缩放推论 | [2506.18530v1](http://arxiv.org/abs/2506.18530v1)
- [09](#article-9) | 06-23 | AnalogNAS-Bench: A NAS Benchmark for Analog In-Memory Computing | AnalogNAS-Bench: Ein NAS-Benchmark für analoges In-Memory Computing | AnalogNAS-Bench:NAS模拟计算基准 | [2506.18495v1](http://arxiv.org/abs/2506.18495v1)
- [10](#article-10) | **06-22 (7)** | AMD Versal Implementations of FAM and SSCA Estimators | AMD-Versal-Implementierungen von FAM und SSCA-Schätzern | AMD 快速实施FAM和SCA模拟器 | [2506.18003v1](http://arxiv.org/abs/2506.18003v1)
- [11](#article-11) | 06-22 | Cost-Effective Optimization and Implementation of the CRT-Paillier   Decryption Algorithm for Enhanced Performance | Kosteneffiziente Optimierung und Implementierung des CRT-Paillier Entschlüsselungs-Algorithmus für verbesserte Leistung | 以成本-效益高的方式优化和实施CRT-PALIer 解密算法,提高性能 | [2506.17935v1](http://arxiv.org/abs/2506.17935v1)
- [12](#article-12) | 06-22 | GainSight: Application-Guided Profiling for Composing Heterogeneous   On-Chip Memories in AI Hardware Accelerators | GainSight: Anwendungsorientierte Profilierung für das Komponieren heterogener On-Chip-Erinnerungen in KI-Hardwarebeschleunigern | GainSight: 在 AI 硬件加速器中组合不同质在芯片上的记忆的应用指导分析 | [2504.14866v3](http://arxiv.org/abs/2504.14866v3)
- [13](#article-13) | **06-21 (6)** | Residue Number System (RNS) based Distributed Quantum Multiplication | Rückstandszahlsystem (RNS) basiert auf verteilter Quanten-Multiplikation | 基于残余数字系统(RNS)的分布量乘法 | [2506.17588v1](http://arxiv.org/abs/2506.17588v1)
- [14](#article-14) | 06-21 | LLM-Aided Testbench Generation and Bug Detection for Finite-State   Machines | LLM-Aided Testbench Generation und Fehlererkennung für Finite-State-Maschinen | LLM 辅助有限国机器的LLM辅助试验箱生成和虫虫检测 | [2406.17132v2](http://arxiv.org/abs/2406.17132v2)
- [15](#article-15) | 06-21 | ASC-Hook: fast and transparent system call hook for Arm | ASC-Hook: Schneller und transparenter Systemrufhaken für Arm | ASC-Hook: 快速和透明的系统调用武器钩 | [2412.05784v4](http://arxiv.org/abs/2412.05784v4)
- [16](#article-16) | **06-20 (5)** | $Δ$-Nets: Interaction-Based System for Optimal Parallel   $λ$-Reduction | $Δ$-Nets: Interaktionsbasiertes System für eine optimale parallele $λ$-Reduktion | $$-净额:最佳平行互动系统$$$美元-削减 | [2505.20314v3](http://arxiv.org/abs/2505.20314v3)
- [17](#article-17) | 06-20 | Assessing Tenstorrent's RISC-V MatMul Acceleration Capabilities | Bewertung der RISC-V-MatMul-Beschleunigungsfähigkeiten von Tenstorrent | 评估出租人的RISC-V MatMul加速能力 | [2505.06085v3](http://arxiv.org/abs/2505.06085v3)
- [18](#article-18) | 06-20 | RCNet: $ΔΣ$ IADCs as Recurrent AutoEncoders | RCNet: $Δω$ IADCs als recurrent AutoEncoder | RCNet:作为经常性自动编码器的空间碎片协委会 | [2506.16903v1](http://arxiv.org/abs/2506.16903v1)
- [19](#article-19) | 06-20 | Lookup Table-based Multiplication-free All-digital DNN Accelerator   Featuring Self-Synchronous Pipeline Accumulation | Lookup Tischbasierte Multiplikationsfreies All-Digital-DNN-Beschleuniger mit selbstsynchroner Pipeline-Akkumulation | 基于表格的无乘法化表格 全数字 DNN 加速器 自动同步管道累积 | [2506.16800v1](http://arxiv.org/abs/2506.16800v1)
- [20](#article-20) | 06-20 | CodeV-R1: Reasoning-Enhanced Verilog Generation | CodeV-R1: Grundlegende Verilog-Generierung | 代码V-R1:有理性的增强性性性性性性性生殖器生成 | [2505.24183v2](http://arxiv.org/abs/2505.24183v2)
- [21](#article-21) | 06-20 | Zoozve: A Strip-Mining-Free RISC-V Vector Extension with Arbitrary   Register Grouping Compilation Support (WIP) | Zoozve: Eine Strip-Mining-freie RISC-V-Vektorerweiterung mit arbitrary Register-Gruppierungsunterstützung (WIP) | Zooozve:利用任意登记册组汇编支助,扩大一个带分解自由的RISC-V矢量扩展区(WIP) | [2504.15678v2](http://arxiv.org/abs/2504.15678v2)
- [22](#article-22) | **06-19 (4)** | SparseDPD: A Sparse Neural Network-based Digital Predistortion FPGA   Accelerator for RF Power Amplifier Linearization | SparseDPD: Ein Sparse Neural Network-basierter Digital Predistortion FPGA Accelerator für RF Leistungsverstärker Linearisierung | SpararseDPD: 一种基于松散神经网络的FPGA 用于RF Power 放大器线性化的松式神经网络数字预感加速器 | [2506.16591v1](http://arxiv.org/abs/2506.16591v1)
- [23](#article-23) | 06-19 | REIS: A High-Performance and Energy-Efficient Retrieval System with   In-Storage Processing | REIS: Ein leistungsstarkes und energieeffizientes Retrieval-System mit In-Storage-Verarbeitung | REIS:具有在系统内处理的高效能和节能检索系统 | [2506.16444v1](http://arxiv.org/abs/2506.16444v1)
- [24](#article-24) | 06-19 | All-in-One Analog AI Hardware: On-Chip Training and Inference with   Conductive-Metal-Oxide/HfOx ReRAM Devices | All-in-One Analog-KI-Hardware: On-Chip-Training und Schlussfolgerung mit leitfähig-Metall-Oxid/HfOx-ReRAM-Geräten | A. AI 硬件:与导体-金属-氧化物/HfOx雷射装置的芯片培训和推断 | [2502.04524v4](http://arxiv.org/abs/2502.04524v4)
- [25](#article-25) | 06-19 | Serving Large Language Models on Huawei CloudMatrix384 | Große Sprachmodelle auf Huawei CloudMatrix384 | 瓦威云马特列克384 | [2506.12708v3](http://arxiv.org/abs/2506.12708v3)
- [26](#article-26) | 06-19 | Microcanonical simulated annealing: Massively parallel Monte Carlo   simulations with sporadic random-number generation | Mikrokanonisches simuliertes Glühen: Massiv parallele Monte-Carlo-Simulationen mit sporadischer Zufalls-Zahlen-Generierung | 模拟微气候模拟Annealing:以零星随机数生成的大规模平行的蒙特卡洛模拟模拟 | [2506.16240v1](http://arxiv.org/abs/2506.16240v1)
- [27](#article-27) | 06-19 | How to Increase Energy Efficiency with a Single Linux Command | Wie man die Energieeffizienz mit einem einzigen Linux-Befehl erhöht | 如何通过单Linux指挥来提高能源效率 | [2506.16046v1](http://arxiv.org/abs/2506.16046v1)
- [28](#article-28) | 06-19 | HetGPU: The pursuit of making binary compatibility towards GPUs | HetGPU: Das Streben nach binärer Kompatibilität gegenüber GPUs | HETGPU: 努力使二进制兼容到 GPUs | [2506.15993v1](http://arxiv.org/abs/2506.15993v1)
- [29](#article-29) | 06-19 | Profile-Guided Temporal Prefetching | Profilgeführtes Temporales Prefetching | 预测性指导时间间隔期 | [2506.15985v1](http://arxiv.org/abs/2506.15985v1)
- [30](#article-30) | **06-18 (3)** | Sudoku: Decomposing DRAM Address Mapping into Component Functions | Sudoku: Dekomponieren von DRAM-Adressen Mapping in Komponentenfunktionen | 数独: 将 DRAM 地址映射解析成元函数 | [2506.15918v1](http://arxiv.org/abs/2506.15918v1)
- [31](#article-31) | 06-18 | Bias Variation Compensation in Perimeter-Gated SPAD TRNGs | Bias Variation Compensation in Perimeter-Gated SPAD TRNGs | 围地的SPAD TRNGs中的比值变化赔偿 | [2506.15888v1](http://arxiv.org/abs/2506.15888v1)
- [32](#article-32) | 06-18 | A System Level Compiler for Massively-Parallel, Spatial, Dataflow   Architectures | Ein System Level Compiler für massiv-Parallel-, räumliche, Datenflussarchitekturen | 用于Massalizy-Parallel、空间、数据流结构的系统级汇编器 | [2506.15875v1](http://arxiv.org/abs/2506.15875v1)
- [33](#article-33) | 06-18 | SR-NCL: an Area-/Energy-Efficient Resilient NCL Architecture Based on   Selective Redundancy | SR-NCL: eine flächen-/energieeffiziente NCL-Architektur basierend auf selektiver Redundanz | SR-NCL:基于选择性冗余的地区/能源/能有效抗力的NCL建筑 | [2506.15634v1](http://arxiv.org/abs/2506.15634v1)
- [34](#article-34) | 06-18 | From Block to Byte: Transforming PCIe SSDs with CXL Memory Protocol and   Instruction Annotation | Von Block zu Byte: Transformation von PCIe SSDs mit CXL Memory Protocol und Instruction Annotation | 从块到字节: 用 CXL 内存协议和指令注释转换 PCIe SSD | [2506.15613v1](http://arxiv.org/abs/2506.15613v1)
- [35](#article-35) | 06-18 | CXL-GPU: Pushing GPU Memory Boundaries with the Integration of CXL   Technologies | CXL-GPU: GPU-Speichergrenzen mit der Integration von CXL-Technologien drücken | CXL-GPU:推动GPU记忆边界与CXL技术一体化 | [2506.15601v1](http://arxiv.org/abs/2506.15601v1)
- [36](#article-36) | 06-18 | Acore-CIM: build accurate and reliable mixed-signal CIM cores with   RISC-V controlled self-calibration | Acore-CIM: Aufbau präziser und zuverlässiger CIM-Kerne mit RISC-V-gesteuerter Selbstkalibrierung | 核心CIM:建立准确可靠的混合信号CIM核心,并配有RISC-V控制的自我校准 | [2506.15440v1](http://arxiv.org/abs/2506.15440v1)
- [37](#article-37) | 06-18 | J3DAI: A tiny DNN-Based Edge AI Accelerator for 3D-Stacked CMOS Image   Sensor | J3DAI: Ein winziger DNN-basierter Edge-KI-Beschleuniger für 3D-gestapelten CMOS-Bildsensor | J3DAI: 用于 3D 堆放 CMOS 图像传感器的小型 DNN 以 DNN 为基础的 AI 自动加速器 | [2506.15316v1](http://arxiv.org/abs/2506.15316v1)
- [38](#article-38) | **06-17 (2)** | Scaling Intelligence: Designing Data Centers for Next-Gen Language   Models | Scaling Intelligence: Konzipieren von Rechenzentren für Sprachmodelle der nächsten Generation | 扩大情报范围:为下一代语言模型设计数据中心 | [2506.15006v1](http://arxiv.org/abs/2506.15006v1)
- [39](#article-39) | 06-17 | VeriLeaky: Navigating IP Protection vs Utility in Fine-Tuning for   LLM-Driven Verilog Coding | VeriLeaky: Navigieren von IP-Schutz gegen Utility in Feinsteuerung für LLM-getriebene Verilog Coding | VeriLeaky:在LLM-Driven Verilog编码精密设计中导航 IP保护相对于实用性 | [2503.13116v4](http://arxiv.org/abs/2503.13116v4)
- [40](#article-40) | 06-17 | ASAP-FE: Energy-Efficient Feature Extraction Enabling Multi-Channel   Keyword Spotting on Edge Processors | ASAP-FE: Energieeffiziente Feature-Extraktion Ermöglichung von Multi-Channel-Schlüsselwort-Spoting auf Edge-Prozessoren | ASAP-FE:能源效率地貌采掘促进多通道关键词 | [2506.14657v1](http://arxiv.org/abs/2506.14657v1)
- [41](#article-41) | 06-17 | Guaranteed Guess: A Language Modeling Approach for CISC-to-RISC   Transpilation with Testing Guarantees | Guaranteed Guess: Ein Sprachmodellierungsansatz für CISC-to-RISC Transpilation mit Testgarantien | 有担保的猜测:具有测试保证的CISC到RISC传输语言模拟方法 | [2506.14606v1](http://arxiv.org/abs/2506.14606v1)
- [42](#article-42) | 06-17 | Empirically-Calibrated H100 Node Power Models for Reducing Uncertainty   in AI Training Energy Estimation | Empirisch kalibrierte H100-Knotenstrommodelle zur Reduzierung von Unsicherheiten in der KI-Trainingsenergieschätzung | AI 培训能源估算中减少不确定性的活性校准 H100 节点动力模型 | [2506.14551v1](http://arxiv.org/abs/2506.14551v1)
- [43](#article-43) | 06-17 | Tensor Manipulation Unit (TMU): Reconfigurable, Near-Memory Tensor   Manipulation for High-Throughput AI SoC | Tensor-Manipulationseinheit (TMU): Rekonfigurierbare, Nahspeicher-Tensor-Manipulation für High-Throughput-KI-SoC | Tensor 操纵装置(TMU):高干压 AI SoC 的可重新配置、近近中间的Tensor 操纵装置 | [2506.14364v1](http://arxiv.org/abs/2506.14364v1)
- [44](#article-44) | 06-17 | CXLMemSim: A pure software simulated CXL.mem for performance   characterization | CXLMemSim: Eine reine Software simulierte CXL.mem für die Leistungscharakterisierung | CXLMemSim:一种模拟CXL.mem用于性能定性的纯软件 | [2303.06153v2](http://arxiv.org/abs/2303.06153v2)
- [45](#article-45) | 06-17 | Comprehensive Verilog Design Problems: A Next-Generation Benchmark   Dataset for Evaluating Large Language Models and Agents on RTL Design and   Verification | Umfassende Verilog-Design-Probleme: Ein Benchmark-Datensatz für die nächste Generation zur Bewertung großer Sprachmodelle und -agenten auf RTL-Design und -Verifikation | 全面的纵向设计问题:用于评价关于RTL设计和核查的大型语言模型和代理人的下一个基准数据集 | [2506.14074v1](http://arxiv.org/abs/2506.14074v1)
...
## Article 12
### Title@2025-06-22 (7): GainSight: Application-Guided Profiling for Composing Heterogeneous   On-Chip Memories in AI Hardware Accelerators
...
AI 工作量导致记忆要求飞涨, 需要超出当前 SRAM 技术所能提供的域特定加速器, 需要更高密度的芯片内存。 我们鼓励算法和应用行为应该指导各种芯片内存储器的构成。 但是, 很少有工作将动态应用剖面纳入这些设计决定, 也没有为此目的明确设计任何现有工具。 我们展示了一个剖析框架, 分析具体域加速器中细微刻度内存访问模式和数据寿命。 通过将可重新定位的建筑模拟后端与应用程序和装置分析前端进行仪器化, 增益视觉应该将特定工作量的流量和寿命指标与新兴存储器的模拟组合结合起来, 向系统级内存设计提供信息。 我们还展示了一套关于 MLPerf 推断和 PolyBench 工作量的案例研究, 使用模拟的GainSightSightSight的阵列结构, 突出GARES的效用及其洞察到的L1和18%的L2 PUPO的内存内存空间, 以及SL2 CRA 的短期访问阵列, 和79 % Slaimal- cal- sal- clas- clasma- slappy 。
...
## Article 26
### Title@2025-06-19 (4): Microcanonical simulated annealing: Massively parallel Monte Carlo   simulations with sporadic random-number generation
...
描述高能和浓缩物质物理的模型和理论的数值模拟 $\ unicode{x2014} 美元 在高能和浓缩物质物理的模型和理论中, 美元 $\ uncode{x2014} 美元 正在变得越来越重要。 例如, lattice 仪表理论, 除其他外, 可以描述量子铬动力学( 标准模型对初级粒子之间强烈互动的描述) 和旋玻璃系统。 除了基础研究外, 这些计算方法还发现, 在优化、 金融和复杂的生物问题等方面, 描述复杂实验系统 的模型和理论 。 然而, 蒙特卡洛 模拟是这些方法的一个重要子类, 正在受到一个重大的倒退的困扰: 它们非常贪婪( 假) 随机数字物理( 假) 随机计算器的总数随着硬件的增加而增加, 并且能够吸引特殊目的计算平台。 我们在这里提议一个通用的微卡纳温度模拟( MI) 正式的地图, 已经完全适应了一种大规模平行的计算方法, 正如我们在三维级的直径直径直径直径的直径直径直径直径直径的直径直径等的直径等等的轨数据序列中, 。 我们进行着的硬质的精确的精确测算。
...
## Article 30
### Title@2025-06-18 (3): Sudoku: Decomposing DRAM Address Mapping into Component Functions

**Title**: Sudoku: Decomposing DRAM Address Mapping into Component Functions | Sudoku: Dekomponieren von DRAM-Adressen Mapping in Komponentenfunktionen | 数独: 将 DRAM 地址映射解析成元函数 [2506.15918v1](http://arxiv.org/abs/2506.15918v1)

**Authors** (5): Minbok Wi, Seungmin Baek, Seonyong Park, Mattan Erez, Jung Ho Ahn
...
将 DRAM 地址映射解析成组件级功能对于理解记忆行为和精确的 RowHammer 袭击至关重要,但现有的反向工程方法却不尽人意。 我们引入了基于时间的新技术,利用 DRAM 的更新间隔和连续存取延迟来推断组件特定功能。 在此基础上, 我们展示了Sudoku, 这是第一个基于软件的工具, 可以自动将 DRAM 地址映射完全分解成频道、 级别、 银行集团和银行功能, 同时识别行和列位位。 我们验证了Sudoku 的效能, 成功地将最近的 Intel 和 AMD 处理器的映射解析 。

---

## Article 31
### Title@2025-06-18 (3): Bias Variation Compensation in Perimeter-Gated SPAD TRNGs

**Title**: Bias Variation Compensation in Perimeter-Gated SPAD TRNGs | Bias Variation Compensation in Perimeter-Gated SPAD TRNGs | 围地的SPAD TRNGs中的比值变化赔偿 [2506.15888v1](http://arxiv.org/abs/2506.15888v1)

**Authors** (3): Md Sakibur Sajal, Hunter Guthrie, Marc Dandin
...
使用 entropy 源元素阵列的随机数生成器存在偏差差异( BV) 。 尽管有高效的降低偏差算法, 硬件友好选项的优化实施取决于原始位数流中的比特偏差, 无法容纳宽度 BV 。 在这项工作中, 我们展示了64 x 64 个周边封闭的单光电雪崩二极管( pgSPADs)阵列, 以0. 35 ~ mu}mum 标准 CMOS 技术制成, 以此为一种诱变源, 用 BV 补偿技术生成随机的双弦字符。 通过应用基于设备本地暗数率的适当门电压, 我们显示在室温下2 kHz/ pixel 的原始位数代率低于1% BV 。 原始位数使用古典迭代 Von Neumann 的算法和除位数位元元元数通过 NIST 统计测试套的全部16 测试。

---

## Article 32
### Title@2025-06-18 (3): A System Level Compiler for Massively-Parallel, Spatial, Dataflow   Architectures

**Title**: A System Level Compiler for Massively-Parallel, Spatial, Dataflow   Architectures | Ein System Level Compiler für massiv-Parallel-, räumliche, Datenflussarchitekturen | 用于Massalizy-Parallel、空间、数据流结构的系统级汇编器 [2506.15875v1](http://arxiv.org/abs/2506.15875v1)

**Authors** (5): Dirk Van Essendelft, Patrick Wingo, Terry Jordan, Ryan Smith, Wissam Saidi
...
我们开发了一个小说编译器,名为高级计算机硬件多建筑汇编器(MACH),专门设计用于大规模平行、空间、数据流结构,如Wafer比例式引擎。此外,MACH可以执行传统统一模拟装置的代码。MACH通过概念虚拟机器、灵活的域名语言和能够根据虚拟机器概念将高语言降为机器专用代码的编译器,解决空间结构汇编的复杂性。MACH设计在几个结构上可以操作,并为若干标准和用户定义的数据绘图提供灵活性。我们用NumPy的密度高的高压示例来介绍这一概念,并以Cerebras硬件特定语言为对象,向瓦费尔比例式引擎展示低调的概念。

---

## Article 33
### Title@2025-06-18 (3): SR-NCL: an Area-/Energy-Efficient Resilient NCL Architecture Based on   Selective Redundancy

**Title**: SR-NCL: an Area-/Energy-Efficient Resilient NCL Architecture Based on   Selective Redundancy | SR-NCL: eine flächen-/energieeffiziente NCL-Architektur basierend auf selektiver Redundanz | SR-NCL:基于选择性冗余的地区/能源/能有效抗力的NCL建筑 [2506.15634v1](http://arxiv.org/abs/2506.15634v1)

**Authors** (3): Hasnain A. Ziad, Alexander C. Bodoh, Ashiq A. Sakib
...
事实证明,基于重复的冗余计划在设计完全耐受力的准易变性不敏感电路(QDI)方面是有效的,但是,在完全恢复能力的同时,还有大量的能量、潜伏和地区间接费用,本文件提出了基于选择性冗余的新颖的耐误 Null公约逻辑(NCL)架构,结果显示,与现有的基于重复的NCL设计相比,拟议方法在面积和能源利用方面的效力,目标是图像处理应用程序。

---

## Article 34
### Title@2025-06-18 (3): From Block to Byte: Transforming PCIe SSDs with CXL Memory Protocol and   Instruction Annotation

**Title**: From Block to Byte: Transforming PCIe SSDs with CXL Memory Protocol and   Instruction Annotation | Von Block zu Byte: Transformation von PCIe SSDs mit CXL Memory Protocol und Instruction Annotation | 从块到字节: 用 CXL 内存协议和指令注释转换 PCIe SSD [2506.15613v1](http://arxiv.org/abs/2506.15613v1)

**Authors** (11): Miryeong Kwon, Donghyun Gouk, Junhyeok Jang, Jinwoo Baek, Hyunwoo You, Sangyoon Ji, Hongjoo Jung, Junseok Moon, Seungkwan Kang, Seungjun Lee, Myoungsoo Jung
...
本文探讨了计算Express Link (CXL) 如何将基于 PCIe 的块状存储转换成可缩放、可字数处理的工作内存。 我们通过强调作为关键助推器的缓存性,并提倡使用称为 CXL-SSD 的3型端点设备来应对将块状存储转换成CXL-SSD 的挑战。 为了验证我们的方法,我们将CXL-SSD 原型放在一个定制的 FPGA 平台上,并提议说明机制,即确定性和缓冲性,以便在保存数据持久性的同时提高性能。 我们的模拟评价表明, CXL-SSD比基于 PCI 的内存扩展器取得10.9x 更好的性能,并通过加注度进一步减少5.4x 的耐久性。 在高地点工作量中, CXL-SDD接近DRAM 一样的性能,以高效的电荷堆积为目的。 这项工作突出了将块状存储并入 CXL 生态系统的可行性,并为未来存储存储中提供基础。

---

## Article 35
### Title@2025-06-18 (3): CXL-GPU: Pushing GPU Memory Boundaries with the Integration of CXL   Technologies

**Title**: CXL-GPU: Pushing GPU Memory Boundaries with the Integration of CXL   Technologies | CXL-GPU: GPU-Speichergrenzen mit der Integration von CXL-Technologien drücken | CXL-GPU:推动GPU记忆边界与CXL技术一体化 [2506.15601v1](http://arxiv.org/abs/2506.15601v1)

**Authors** (11): Donghyun Gouk, Seungkwan Kang, Seungjun Lee, Jiseon Kim, Kyungkuk Nam, Eojin Ryu, Sangwon Lee, Dongpyung Kim, Junhyeok Jang, Hanyeoreum Bae, Myoungsoo Jung
...
这项工作引入了使用 CXL 的 GPU 存储扩展解决方案, 其特点是具有多个 CXL 根端端的新型 GPU 系统设计, 用于整合多种存储介质( DRAMs 和/或 SSDs) 。 我们开发并整合了硬件 RTL 级的自定义 CXL 控制器, 实现两位数的 纳米第二轮回转延迟, 首先是实地的。 此研究还包括用于有效管理读写操作以隐藏端点后端介质延迟的读写操作的投机性和确定性存储器机制 。 绩效评估显示, 我们的方法大大超过现有方法, 标志着 GPU 存储技术的显著进步 。

---

## Article 36
### Title@2025-06-18 (3): Acore-CIM: build accurate and reliable mixed-signal CIM cores with   RISC-V controlled self-calibration

**Title**: Acore-CIM: build accurate and reliable mixed-signal CIM cores with   RISC-V controlled self-calibration | Acore-CIM: Aufbau präziser und zuverlässiger CIM-Kerne mit RISC-V-gesteuerter Selbstkalibrierung | 核心CIM:建立准确可靠的混合信号CIM核心,并配有RISC-V控制的自我校准 [2506.15440v1](http://arxiv.org/abs/2506.15440v1)

**Authors** (9): Omar Numan, Gaurav Singh, Kazybek Adam, Jelin Leslin, Aleksi Korsman, Otto Simola, Marko Kosunen, Jussi Ryynänen, Martin Andraud
...
开发准确和可靠的计算计量(CIM)架构正在成为一个关键的研究焦点,以加速人工智能(AI)硬件任务,特别是深神经网络(DNN)。在这方面,人们对模拟和混合信号的CIM架构非常感兴趣,目的是提高数据存储和计算效率,以处理DNNS所需要的大量数据。具体地说,在新兴非流动性存储(eNVM)的解决方案中,耐性混合信号 CIM核心正在成为关键的研究焦点。然而,混合信号的 CIM计算核心仍然面临着若干整合和可靠性挑战,这阻碍了它们被大规模采用端到端到端的AI计算系统。在整合、耐性和基于 ENM CIM 的核心方面,需要与控制处理器整合,以实现端到端的AI加速。此外,基于SRAM 的 CIM 架构仍然比其基于直径直的对等系统更高效和更容易进行编程。在可靠性方面,类比电路更易变,导致计算错误,并导致直径直径的直径直径的计算,在SIM IM 系统上,这需要整合一个控制流程测试,通过SIM 快速的SIM 将SIM 显示两个挑战通过SIM 。

---

## Article 37
### Title@2025-06-18 (3): J3DAI: A tiny DNN-Based Edge AI Accelerator for 3D-Stacked CMOS Image   Sensor

**Title**: J3DAI: A tiny DNN-Based Edge AI Accelerator for 3D-Stacked CMOS Image   Sensor | J3DAI: Ein winziger DNN-basierter Edge-KI-Beschleuniger für 3D-gestapelten CMOS-Bildsensor | J3DAI: 用于 3D 堆放 CMOS 图像传感器的小型 DNN 以 DNN 为基础的 AI 自动加速器 [2506.15316v1](http://arxiv.org/abs/2506.15316v1)

**Authors** (12): Benoit Tain, Raphael Millet, Romain Lemaire, Michal Szczepanski, Laurent Alacoque, Emmanuel Pluchart, Sylvain Choisnet, Rohit Prasad, Jerome Chossat, Pascal Pierunek, Pascal Vivet, Sebastien Thuries
...
本文介绍了基于 J3DAI 的微小深神经网络硬件加速器 J3DAI , 是一个用于3层3D堆叠的 CMOS 图像传感器的微小神经网络硬件加速器, 其特点是人工智能芯片(AI) 集深神经网络(DNN) 的加速器。 DNN 加速器旨在高效完成图像分类和分解等神经网络任务。 本文侧重于 J3DAI 的数字系统, 突出其性能- 区域( PPAA) 特性, 展示CMOS 图像传感器上高级高级的高级AI能力。 为了支持硬件, 我们使用了 Aidge 综合软件框架, 使主机处理器和 DNNC 加速器能够同时整合。 Aidge 支持培训后的评分, 大幅减少记忆足迹和计算复杂性, 使J3DAI 等受资源限制的硬件的部署模式变得至关重要。 我们的实验结果显示, 在边缘AI 领域, 展示其处理简单和计算密集的任务的潜力。
...
## Article 39
### Title@2025-06-17 (2): VeriLeaky: Navigating IP Protection vs Utility in Fine-Tuning for   LLM-Driven Verilog Coding

**Title**: VeriLeaky: Navigating IP Protection vs Utility in Fine-Tuning for   LLM-Driven Verilog Coding | VeriLeaky: Navigieren von IP-Schutz gegen Utility in Feinsteuerung für LLM-getriebene Verilog Coding | VeriLeaky:在LLM-Driven Verilog编码精密设计中导航 IP保护相对于实用性 [2503.13116v4](http://arxiv.org/abs/2503.13116v4)

**Authors** (10): Zeng Wang, Minghao Shao, Mohammed Nabeel, Prithwish Basu Roy, Likhitha Mankali, Jitendra Bhandari, Ramesh Karri, Ozgur Sinanoglu, Muhammad Shafique, Johann Knechtel
...
大型语言模型( LLMs) 提供了重要的编码潜力, 但是微调( FT ) 却对Verilog 等利基语言至关重要。 使用专有知识产权( IP) 来为FT 使用基底 Verilog 数据库( RTLCoder ) 带来严重的风险, 因为FT 数据可以通过 LLM 推断泄漏。 这导致设计房屋面临一个关键性的两难: 寻求建立外部可获取的LLMs , 提供竞争性 Verilog 编码, 如何利用内部IP 来提高FT 效用,同时确保IP 保护? 我们在文献中首次研究了这一难题。 使用LalaMA 3.1-8B , 我们用一个基底的 Verilog 数据库( RTLCorder) 进行内部FT , 补充我们的内部IP IP 数据库( RTLC ) 数据库( RTLC RT) , 通过多层磁带图解的验证验证。 为了充分评估 IPM 的实用性设计策略, 需要某种程度的精确性研究。

---

## Article 40
### Title@2025-06-17 (2): ASAP-FE: Energy-Efficient Feature Extraction Enabling Multi-Channel   Keyword Spotting on Edge Processors

**Title**: ASAP-FE: Energy-Efficient Feature Extraction Enabling Multi-Channel   Keyword Spotting on Edge Processors | ASAP-FE: Energieeffiziente Feature-Extraktion Ermöglichung von Multi-Channel-Schlüsselwort-Spoting auf Edge-Prozessoren | ASAP-FE:能源效率地貌采掘促进多通道关键词 [2506.14657v1](http://arxiv.org/abs/2506.14657v1)

**Authors** (5): Jongin Choi, Jina Park, Woojoo Lee, Jae-Jin Lee, Massoud Pedram
...
多通道关键字定位( KWS) 对边缘环境中基于声音的应用至关重要 。 但是, 其大量的计算和能源需求带来了巨大的挑战 。 我们引入了 ASAP- FE ( Agile Sparity-Award Plain- Fature 提取器) , 硬件导向的前端端, 旨在应对这些挑战。 我们的框架包含三个关键创新:(1) 半覆式的Infinite Impulse 响应( IIR ) : 将冗余数据减少约25%, 同时保持基本的电话流流流转换提示 。 (2) 减少: 我们利用框架级的垃圾存储器和基于斜度过滤的过滤器, 来调整50%的数据。 我们引入了一个可参数化的过滤器组合和基于优先的列表算法, 使IIR的过滤任务能够平行进行, 降低粘固度, 在边缘处理器上采用各种过滤器尺寸, 功能在 FPCNGA 样板上进行验证, 将数据合成为45 nm; 通过SWT- Referal- Develrial IM 提供最佳的运行结果, AS- droupal AS- droupal AS to a less a less a less a less laveild laveal laveal laveal 。
...
**Title**: Guaranteed Guess: A Language Modeling Approach for CISC-to-RISC   Transpilation with Testing Guarantees | Guaranteed Guess: Ein Sprachmodellierungsansatz für CISC-to-RISC Transpilation mit Testgarantien | 有担保的猜测:具有测试保证的CISC到RISC传输语言模拟方法 [2506.14606v1](http://arxiv.org/abs/2506.14606v1)
...
## Article 42
### Title@2025-06-17 (2): Empirically-Calibrated H100 Node Power Models for Reducing Uncertainty   in AI Training Energy Estimation

**Title**: Empirically-Calibrated H100 Node Power Models for Reducing Uncertainty   in AI Training Energy Estimation | Empirisch kalibrierte H100-Knotenstrommodelle zur Reduzierung von Unsicherheiten in der KI-Trainingsenergieschätzung | AI 培训能源估算中减少不确定性的活性校准 H100 节点动力模型 [2506.14551v1](http://arxiv.org/abs/2506.14551v1)

**Authors** (7): Alex C. Newkirk, Jared Fernandez, Jonathan Koomey, Imran Latif, Emma Strubell, Arman Shehabi, Constantine Samaras
...
由于AI的能源需求在继续增长,因此,提高对这一需求特点的理解,改善电网基础设施规划和环境评估至关重要。通过将Brookhaven国家实验室在AI8-GPU H100系统培训期间的经验性测量与开放源基准数据相结合,我们开发了计算强度与节点电力消耗有关的统计模型。我们测量了在AI培训期间制造商定级热设计功率(TDP)与实际电力需求之间的差距。我们的分析显示,即使计算密集的工作量也只能达到10.2千瓦TDP评级的76 % 。我们根据浮动点操作校准的具体建筑模型预测能源消耗为11.4%的绝对百分比误差,显著超过基于TDP的方法(27-37%误差 ) 。我们确定了变压器和CNN结构之间不同的电量特征,变压器显示可能会影响电网的稳定性。

---

## Article 43
### Title@2025-06-17 (2): Tensor Manipulation Unit (TMU): Reconfigurable, Near-Memory Tensor   Manipulation for High-Throughput AI SoC

**Title**: Tensor Manipulation Unit (TMU): Reconfigurable, Near-Memory Tensor   Manipulation for High-Throughput AI SoC | Tensor-Manipulationseinheit (TMU): Rekonfigurierbare, Nahspeicher-Tensor-Manipulation für High-Throughput-KI-SoC | Tensor 操纵装置(TMU):高干压 AI SoC 的可重新配置、近近中间的Tensor 操纵装置 [2506.14364v1](http://arxiv.org/abs/2506.14364v1)

**Authors** (7): Weiyu Zhou, Zheng Wang, Chao Chen, Yike Li, Yongkui Yang, Zhuoyu Wu, Anupam Chattopadhyay
...
虽然AISOC设计方面最近的进展在很大程度上集中于加速高压计算,但以高容量和微量数据流动为核心的强压操纵同样至关重要的任务仍未得到充分探讨。这项工作通过引入Tensor操纵股(TMU)来弥补这一差距,TMU是一个可重新配置的近模硬件块,旨在高效执行数据移动密集操作者。TMU利用RISC激励的执行模式和统一处理抽象,以记忆到模拟的方式操控长流,利用RISC激励的执行模式和统一处理抽象,使以高容量和微量数据流动为核心的强压操纵能够得到广泛支持。TMUPU与高通气流的AISOC(TMU)内的一个TPU(TMU)一起,利用双倍缓冲和输出推进管道利用。在SMIC 40m技术中,TMU只占用0.019毫米2,同时支持10多个具有代表性的抗压操纵操作者。基准显示,仅TMU(TMU)与AR72和NVA JEX2的递增操作能力分别在TU(AI-DER)中实现自动递减34)。

---

## Article 44
### Title@2025-06-17 (2): CXLMemSim: A pure software simulated CXL.mem for performance   characterization

**Title**: CXLMemSim: A pure software simulated CXL.mem for performance   characterization | CXLMemSim: Eine reine Software simulierte CXL.mem für die Leistungscharakterisierung | CXLMemSim:一种模拟CXL.mem用于性能定性的纯软件 [2303.06153v2](http://arxiv.org/abs/2303.06153v2)

**Authors** (6): Yiwei Yang, Brian Zhao, Yusheng Zheng, Pooneh Safayenikoo, Tanvir Ahmed Khan, Andi Quinn
...
CXLMemSim 是一个快速、轻巧的模拟框架, 使得基于 Compute Express Link (CXL).meem 技术的记忆系统能够进行性能定性。 CXL.mem 允许对记忆进行分类和集合, 以减少云层和数据中心环境中的内存保持( 完全装入服务器的内存未充分利用的内存) 。 然而, CXL 附加的内存与本地 DRA 相比, 真实的 CXL.mem 硬件还无法广泛用于实证评估。 CXMemSim 在软件中附加未改进的应用程序,并模拟基于 CXL的内存存储库库库。 CX 将内存分配和存的内存数据转换为CLlm 的准确性能。 CX 用于实时的内存和内存访问模式,我们用 CX 的内存服务器的内存数据显示, 内存的内存的内存和内存的内存系统显示, 内存的内存的内存的内存数据流数据流数据流数据流数据记录。

---

## Article 45
### Title@2025-06-17 (2): Comprehensive Verilog Design Problems: A Next-Generation Benchmark   Dataset for Evaluating Large Language Models and Agents on RTL Design and   Verification

**Title**: Comprehensive Verilog Design Problems: A Next-Generation Benchmark   Dataset for Evaluating Large Language Models and Agents on RTL Design and   Verification | Umfassende Verilog-Design-Probleme: Ein Benchmark-Datensatz für die nächste Generation zur Bewertung großer Sprachmodelle und -agenten auf RTL-Design und -Verifikation | 全面的纵向设计问题:用于评价关于RTL设计和核查的大型语言模型和代理人的下一个基准数据集 [2506.14074v1](http://arxiv.org/abs/2506.14074v1)

**Authors** (8): Nathaniel Pinckney, Chenhui Deng, Chia-Tung Ho, Yun-Da Tsai, Mingjie Liu, Wenfei Zhou, Brucek Khailany, Haoxing Ren
...
我们提出了全面纵向设计问题基准(CVDP),这是推进LLM和硬件设计和核查代理研究的新数据集和基础设施。CVDP包括13个任务类别中的783个问题,包括RTL的生成、核查、调试、规格调整和由有经验的硬件工程师撰写的技术“A”;在非试剂和代理格式方面都提出了问题。该基准提出了比以往工作更现实和更具挑战性的背景,在代码生成方面,最新模型的通过率不超过34%@1。 Agric 任务$\uncode{2013}$,特别是涉及RTL的再利用和核查$uncode{x2013}$,尤其困难。评价使用开放源工具和模型评分基础设施,通过BLEU和LM的评分。CVDP揭示了当前模型能力的巨大差距,强调需要继续研究,以实现强健的、真实世界硬件设计自动化。
